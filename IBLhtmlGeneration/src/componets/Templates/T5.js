export function getTemplate5(data, TemplateHelpers, lightColor) {
  return `
<!DOCTYPE html>
<html>
<head>
...
export function getTemplate5preview(data, TemplateHelpers, lightColor) {
  return `
    <!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main">
  <div class="container">
    ...
    <a href="https://www.indusind.com/" target="_blank" rel="noopener">
        <img src="${data.networklogo}" alt="IndusInd Bank Logo">
      </a>
      <a href="https://www.indusind.com/" target="_blank" rel="noopener">
...
if (functionName === "preview") {
  return getTemplate5preview(data, TemplateHelpers, lightColor);
} else {
